...
import '../../common/widgets/mr_app_bar_body.dart';
...
class MaintenanceRequestForm extends StatefulWidget {
  ...
  const MaintenanceRequestForm(
      {super.key, this.isUpdate = false, this.mrDetails});
...
class _MaintenanceRequestFormState extends State<MaintenanceRequestForm> {
  ...
  final TextEditingController _responsibleGroupController =
      TextEditingController();
  ...
  final TextEditingController _currentLifecycleStateController =
      TextEditingController();
  final TextEditingController _numberOfFaultsController =
      TextEditingController();
  ...
  void _populateFields() {
    ...
    _responsibleGroupController.text =
        details['ResponsibleWorkerGroup']?.toString() ?? '';
    _responsibleController.text =
        details['ResponsibleWorker']?.toString() ?? '';
    _workOrderController.text = details['WorkOrder']?.toString() ?? '';
    _currentLifecycleStateController.text =
        details['CurrentLifecycleState']?.toString() ?? '';
    _numberOfFaultsController.text =
        details['NumberOfFaults']?.toString() ?? '';
  }
  ...
  Future<void> updateMaintenanceRequest() async {
    final url =
        Uri.parse('${baseUrl}maintenanceRequests/${widget.mrDetails!['_id']}');
  ...
  void _navigateToMRDetailsPage() {
    Navigator.pushReplacement(
      ...
      MaterialPageRoute(
        builder: (context) =>
            MRDetailsPage(RequestID: _requestIDController.text),
      ),
    );
  }
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20.0),
                  CustomTextFormField(
                      labelText: 'Maintenance Request Type',
                  ...
                  const SizedBox(height: 20.0),
                  CustomTextFormField(
                      labelText: 'Maintenance Job Variant',
                      controller: _jobVariantController),
                  const SizedBox(height: 20.0),
                  CustomTextFormField(
                      labelText: 'Maintenance Job Trade',
                      controller: _jobTradeController),
                  const SizedBox(height: 20.0),
                  GestureDetector(
                  ...
                  CustomTextFormField(
                      ...
                      controller: _startedByController),
                  const SizedBox(height: 20.0),
                  CustomTextFormField(
                      labelText: 'Responsible Worker Group',
                      controller: _responsibleGroupController),
                  const SizedBox(height: 20.0),
                  CustomTextFormField(
                      labelText: 'Responsible Worker',
                  ...
                  CustomTextFormField(
                      ...
                      controller: _currentLifecycleStateController),
                  const SizedBox(height: 20.0),
                  CustomTextFormField(
                      labelText: 'Number Of Faults',
                      controller: _numberOfFaultsController),
                  const SizedBox(height: 20.0),
                  Align(
