  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoading
          ...
          : _mrDetails == null
              ? const Center(
                  child: Text('Maintenance request details not found'))
              : Column(
                  children: [
                    mrAppBarBody(context,
                        isMRDetailsPage: true, mrDetails: _mrDetails),
                    Expanded(
                      child: ListView(
                        ...
                        children: [
                          ...
                          _buildDetailCard(Icons.confirmation_number,
                              'Request ID', _mrDetails!['RequestID']),
                          _buildDetailCard(Icons.category, 'Request Type',
                              _mrDetails!['RequestType']),
                          _buildDetailCard(Icons.description, 'Description',
                              _mrDetails!['Description']),
                          _buildDetailCard(Icons.assessment, 'Service Level',
                              _mrDetails!['ServiceLevel']),
                          _buildDetailCard(
                              Icons.location_on,
                              'Functional Location',
                              _mrDetails!['FunctionalLocation']),
                          _buildDetailCard(Icons.precision_manufacturing,
                              'Asset', _mrDetails!['Asset']),
                          //_buildDetailCard(Icons.verified, 'Asset Verified', _formatAssetVerified(_mrDetails!['AssetVerified'])),
                          _buildDetailCard(Icons.build, 'Maintenance Job Type',
                              _mrDetails!['JobType']),
                          _buildDetailCard(
                              Icons.settings_applications,
                              'Maintenance Job Type Variant',
                              _mrDetails!['JobVariant']),
                          _buildDetailCard(
                              Icons.handyman, 'Trade', _mrDetails!['JobTrade']),
                          _buildDetailCard(Icons.timer, 'Actual Start',
                              _mrDetails!['ActualStart']),
                          _buildDetailCard(Icons.person, 'Started By',
                              _mrDetails!['StartedByWorker']),
                          _buildDetailCard(Icons.group, 'Responsible Group',
                              _mrDetails!['ResponsibleWorkerGroup']),
                          _buildDetailCard(
                              Icons.person_pin,
                              'Responsible Worker',
                              _mrDetails!['ResponsibleWorker']),
                          _buildDetailCard(Icons.work, 'Work Order',
                              _mrDetails!['WorkOrder']),
                          _buildDetailCard(
                              Icons.timeline,
                              'Current Lifecycle State',
                              _mrDetails!['CurrentLifecycleState']),
                          _buildDetailCard(Icons.warning, 'Number Of Faults',
                              _mrDetails!['NumberOfFaults']),
